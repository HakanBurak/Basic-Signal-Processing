...
dECG = @(t,S) [(1- sqrt(S(1)^2+S(2)^2))*S(1)-w*S(2);(1- sqrt(S(1)^2+S(2)^2))*S(2)+w*S(1);-(a_i*(rem((atan2(S(2),S(1))) - theta_i,2*pi))*exp(-((rem((atan2(S(2),S(1))) - theta_i,2*pi))^2/2*b_i^2))-S(3)+z0)]; 
